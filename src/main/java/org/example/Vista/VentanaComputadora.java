...
public class VentanaComputadora extends JFrame {
    ...
    public VentanaComputadora(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(22, 155, 204));
        ...
        panel2.setBackground(new Color(231, 11, 239));
        ...
        panel3.setBackground(new Color(9, 126, 6));
        ...
        panel4.setBackground(new Color(204, 22, 64));
